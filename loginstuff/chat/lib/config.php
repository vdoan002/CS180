...
// Database hostname:
$config['dbConnection']['host'] = 'fdb7.biz.nf';
// Database username:
$config['dbConnection']['user'] = '2121719_db';
// Database password:
$config['dbConnection']['pass'] = 'avire117';
// Database name:
$config['dbConnection']['name'] = '2121719_db';
// Database type:
