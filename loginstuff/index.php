<html>
    ...
    <body>
        <div id="landing">
			<h1 color="white">Welcome to UCR Craigslist!</h1>
			<div class="container">
				<img align="middle" alt="UCR Logo" src="images/ucr_logo.png">
			</div>
			<p>
		...
		<div id="info">
			...
			<div class="wrapper" color="black">
				<blockquote class="blockquote">
					...
					<footer class="blockquote-footer">Tristan Zickovich</footer>
				</blockquote>
				<blockquote class="blockquote">
